...
(history.state?history.state.id!==a?history.replaceState({anchorId:a},null,a):history.pushState({anchorId:a},null,a):history.pushState({anchorId:a},null,a));return this};d.prototype.applyHandlers=function(a){null!=a.options.responsive&&a.$win.on("resize.navbar",c.proxy(a.resize,a.$win[0],a)).on("resize.navbar",c.proxy(a.resizeWrap,a)).on("resize.navbar",c.proxy(a.stickUp,null!=a.$clone?a.$clone:a.$element,a)).on("orientationchange.navbar",c.proxy(a.resize,a.$win[0],a)).trigger("resize.navbar");a.$doc.on("scroll.navbar",
    c.proxy(a.stickUp,null!=a.$clone?a.$clone:a.$element,a)).on("scroll.navbar",c.proxy(a.activateAnchor,a));a.$element.add(a.$clone).find("[data-rd-navbar-toggle]").each(function(){var b;b=c(this);b.on("click",c.proxy(a.switchToggle,this,a));return b.parents("body").on("click",c.proxy(a.closeToggle,this,a))});a.$element.add(a.$clone).find(".rd-navbar-submenu").each(function(){var b,e;b=c(this);e=b.parents(".rd-navbar--is-clone").length?a.cloneTimer:a.focusTimer;b.on("mouseleave.navbar",c.proxy(a.dropdownOut,
    this,a,e));b.find("> a").on("mouseenter.navbar",c.proxy(a.dropdownOver,this,a,e));b.find("> .rd-navbar-submenu-toggle").on("click",c.proxy(a.dropdownToggle,this,a));return b.parents("body").on("click",c.proxy(a.dropdownClose,this,a))});a.$element.add(a.$clone).find('.rd-navbar-nav a[href^="#"]').each(function(){return c(this).on("click",c.proxy(a.goToAnchor,this,a))});return a};d.prototype.switchClass=function(a,b,e){a=a instanceof jQuery?a:c(a);a.addClass("rd-navbar--no-transition").removeClass(b).addClass(e);
    a[0].offsetHeight;return a.removeClass("rd-navbar--no-transition")};d.prototype.setDataAPI=function(a){var b,c,d,f;a=["-","-xs-","-sm-","-md-","-lg-"];f=[0,480,768,992,1200];b=c=0;for(d=f.length;c<d;b=++c)this.$element.attr("data"+a[b]+"layout")&&(this.options.responsive[f[b]]||(this.options.responsive[f[b]]={}),this.options.responsive[f[b]].layout=this.$element.attr("data"+a[b]+"layout")),this.$element.attr("data"+a[b]+"device-layout")&&(this.options.responsive[f[b]]||(this.options.responsive[f[b]]=
{}),this.options.responsive[f[b]].deviceLayout=this.$element.attr("data"+a[b]+"device-layout")),this.$element.attr("data"+a[b]+"hover-on")&&(this.options.responsive[f[b]]||(this.options.responsive[f[b]]={}),this.options.responsive[f[b]].focusOnHover="true"===this.$element.attr("data"+a[b]+"hover-on")),this.$element.attr("data"+a[b]+"stick-up")&&(this.options.responsive[f[b]]||(this.options.responsive[f[b]]={}),this.options.responsive[f[b]].stickUp="true"===this.$element.attr("data"+a[b]+"stick-up")),
this.$element.attr("data"+a[b]+"auto-height")&&(this.options.responsive[f[b]]||(this.options.responsive[f[b]]={}),this.options.responsive[f[b]].autoHeight="true"===this.$element.attr("data"+a[b]+"auto-height")),this.$element.attr("data"+a[b]+"stick-up-offset")&&(this.options.responsive[f[b]]||(this.options.responsive[f[b]]={}),this.options.responsive[f[b]].stickUpOffset=this.$element.attr("data"+a[b]+"stick-up-offset"))};d.prototype.getOption=function(a){var b,c;for(b in this.options.responsive)b<=
l.innerWidth&&(c=b);return null!=this.options.responsive&&null!=this.options.responsive[c][a]?this.options.responsive[c][a]:this.options[a]};return d}();c.fn.extend({RDNavbar:function(d){var a;a=c(this);if(!a.data("RDNavbar"))return a.data("RDNavbar",new m(this,d))}});return l.RDNavbar=m})(window.jQuery,document,window);"undefined"!==typeof module&&null!==module?module.exports=window.RDNavbar:"function"===typeof define&&define.amd&&define(["jquery"],function(){return window.RDNavbar})}).call(this);
